...
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'asti.csd.recruitment.acl.AdminAccountPermission'
grails.plugin.springsecurity.authority.className               = 'asti.csd.recruitment.acl.Permission'
